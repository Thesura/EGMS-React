    ...
    return(
        <Card className="menu-card menu-card-sky mt-3 mx-5">
          ...
          <div className="flex flex-col h-3/4">
            ...
            <Link to={link} className="link-button link-button-sky mx-5 h-1/3 lg:mb-10 lg:h-1/4">
              {linkText}
            </Link>
          </div>
        </Card>
    ...
    return(
        <Card className="menu-card menu-card-emerald mt-3 mx-5">
          ...
          <div className="flex flex-col h-3/4">
            ...
            <Link to={link} className="link-button link-button-emerald mx-5 h-1/3 lg:mb-10 lg:h-1/4">
              {linkText}
            </Link>
          </div>
        </Card>
